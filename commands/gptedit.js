...
// Enable experimental features for webp-converter on supported platforms
if (process.platform !== "android") webp.grant_permission();
...
async function gpteditCommand(sock, chatId, message) {
    try {
        ...
        const tempDir = path.join(os.tmpdir(), "bony-xmd-temp");
