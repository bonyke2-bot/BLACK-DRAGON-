...
exports.jam = (numer, options = {}) => {
    ...
    let timeZone = options?.timeZone ? options.timeZone : "Africa/Nairobi"
    let jam = options?.timeZone ? moment(numer).tz(timeZone).format(format) : moment(numer).tz("Africa/Nairobi").format(format)
